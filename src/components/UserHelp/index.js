...
八、如何联系我们
1、如果您有任何要求和意见，您可以通过电子邮件support@huobigroup.com，这是属于我们与您沟通的唯一有效和官方电子邮件，所以我们对您未使用有效的联系方式，任何作为或不作为不承担责任。
2、我们只通过本平台上的有效的联系方式发布公告和信息或在本平台张贴公告，所以我们对由于您信任了未通过以上方式获得的信息而产生的任何损失不承担责任。
3、若您对我们的隐私政策有任何问题, 欢迎随时联系我们。`}
    </pre>
  </div>
);
function showModal() {
...
function showModal2() {
  const alertInstance = alert('隐私政策', text2, [{ text: '我已知晓', onPress: () => alertInstance.close() }]);
}
export default function UserHelp() {
  return (
    <div className="user-link">
      ...
      》和《
      <span className="link" onClick={showModal2}>
        隐私政策
      </span>
      》
    </div>
